(function() {
    ...
    asyncTest('Same origin, different sources, correct routing', 2, function() {
        var iframe1 = createIframe('Frame1', sameDomainEchoPath);
        var iframe2 = createIframe('Frame2', sameDomainEchoPath);
        var comm1;
        var comm2;
        var loadCount = 0;
        var messageCount = 0;
    ...
    asyncTest('Different origins, different sources, correct routing', 2, function() {
        var iframe1 = createIframe('Frame1', crossDomainEchoPath);
        var iframe2 = createIframe('Frame2', sameDomainEchoPath);
        var comm1;
        var comm2;
        var loadCount = 0;
